...
def main(black, white):
    ...
    while run :
        ...
        n.getNumOfPlayer()
        if n.NumberofPlayers<2:
            screen.blit(large.render("Disconnected", True, (255, 0, 0)), (10, 150))
            pygame.display.update()
            time.sleep(2)
            break
        ...
        if ActivePlayer==ID and updatedboard==False:
            bo=n.getBoard()

            updatedboard=True
           

        if n.getGameState()==ID:
            screen.blit(large.render("CheckMate", True, (255, 0, 0)), (10, 150))
            screen.blit(large.render("You Won", True, (255, 0, 0)), (10, 225))
